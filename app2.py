...
# ==================================================
    ...
    st.dataframe(summary_df.style.highlight_max(axis=0, color='#d4edda'), width="stretch")
...
# ==================================================
    ...
    st.dataframe(threshold_summary, width="stretch", hide_index=True)
...
# ==================================================
    ...
    predict_clicked = st.button('🔍 Assess Risk', width="stretch", type='primary')
